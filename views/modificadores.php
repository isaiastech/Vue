...
<body>
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center display-5 fst-italic">Modificadores</h1>                  
            ...
            <div class="div" id="app">
                <a href="https://isaiastech.app.br" target="_blank" v-on:click="previnirComportamentoPadrao($event)">Comportamento padrão</a>
                <p>{{msg}}</p>
                <button @click="executarUmaVez()">Botão</button>
                <p>Cliques: {{ cliques }}</p>
            </div>
    ...
    <script src="../templates/modificador.js"></script>
