...
<body>
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center display-5 fst-italic">Diretiva V-on</h1>
            ...
            <div id="app">
                <button @click="imprimirTexto('Olá, Vue!', 42)">Chamar imprimirTexto</button>
                <button @click="mensagemAlerta($event)">Mostrar Evento</button>
            </div>
    ...
    <script src="../templates/diretivav-on.js"></script>
