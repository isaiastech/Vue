...
<head>
    ...
    <title>Selecionando elemento filho</title>
</head>
...
<body>
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <h1 class="text-center display-5 fst-italic">Selecionando elemento filho</h1>                  
            ...
            <!-- Colocar código abaixo -->
             <div id="app">
                <input type="text" name="texto" id="inputTexto">
                ...
                <br>
                <p id="paragrafo" class="paragrafo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium optio 
                    itaque, alias aliquam nulla iusto, rerum eos libero, et vero nemo 
                    tenetur eligendi reprehenderit facilis iste mollitia voluptatem minus maxime.</p>
    ...
    <script src="../templates/elementoFilho.js"></script>
