...
<body>
    <main>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                        <h1 class="text-center display-5 fst-italic">Instanciando Elementos</h1>                  
            ...
            <div class="row">
                ...
                <p class="display-6 text-success">{{mensagem[1]}}</p>
                <p>{{mensagem[0]}}</p>
                </div>
    ...
    <script src="../templates/vmViewModel.js"></script>
